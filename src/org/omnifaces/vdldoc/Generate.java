...
public class Generate {
	...
	public static void main(String[] args) throws Exception {
		File omniFacesPagesProject = new File("").getAbsoluteFile();
		File omniFacesProject = new File(omniFacesPagesProject.getParentFile(), "/omnifaces");
		...
		generator.setOutputDirectory(new File(omniFacesPagesProject, "/vdldoc/current"));
